...
//	    precondition.MonitorCRD(schema.GroupKind{
...
// # Built-In Checks
//
// [MonitorCRD] and [MonitorCRDs] check for CRD presence using
// [cluster.HasCRD]. [Custom] wraps any caller-provided [CheckFunc].
//
// # Functional Options
//
